    ...
    >
      <div
        className={`transition-all duration-[250ms] ${
          darkMode ? "bg-aside_onboard" : "bg-sidebar_light"
        } ${
          isMenuClicked
            ? "   w-[65%] sm:w-1/2  absolute right-0  animate-rollLeft h-full "
            : "max-w-[500px]  mt-[47px]  w-full"
        } lg:absolute top:0 lg:left-0 flex mx-auto lg:max-w-full pb-6 lg:min-h-screen h-full  lg:w-full  lg:mt-0`}
      >
        <div
