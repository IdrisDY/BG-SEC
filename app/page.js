        ...
        >
          <div className={`lg:w-4/5 flex items-center justify-between m-auto`}>
            <div className={`flex flex-col gap-2 lg:gap-8`}>
              <span
                className={` ${
                  theme.mode === "dark" ? "text-white" : "text-dark_green_90 "
                }  ${
                  DMFont.className
        ...
        <div className={`lg:py-[4.5rem] px-[5px] lg:px-0 flex`}>
          <div
            className={`flex lg:w-[90%] ml-auto h-[350px] ${
              theme.mode === "dark" ? "bg-dark-gradient" : "bg-light-gradient"
      ...
      >
        ...
        >
          {Array.from({ length: 3 }).map((item, index) => {
            return (
              <div
                className={`w-4/5 lg:w-[30%] m-auto lg:m-0 shadow-custom1 flex flex-col gap-4 ${
                  theme.mode === "dark"
